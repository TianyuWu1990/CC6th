//package CC4_8_FIRST_COMMON_ANCESTOR;
//
...
//				TreeNode r1 = ON_PATH.commonAncestor(x, y);
//				TreeNode r2 = GO_TO_SAME_DEPTH.commonAncestor(x, y);
//				TreeNode r3 = SIBLING.commonAncestor(root, x, y);
//				TreeNode r4 = COVER_UNTIL_SEPERATE.commonAncestor(root, x, y);
//				TreeNode r5 = OPTIMIZE.commonAncestor(root, x, y);
//

...
public class _____FLEXIBLE_STACK_____ {
	public static void printStacks(_____MultiStack_____ stacks) {
	...
	public static void main(String [] args) throws Exception  {	
		_____MultiStack_____ stacks = new _____MultiStack_____(3, 4);
		printStacks(stacks);
		stacks.push(0, 10);
		printStacks(stacks);
		stacks.push(1, 20);
